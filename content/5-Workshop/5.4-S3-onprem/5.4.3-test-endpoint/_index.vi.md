...
![dns name](/AWS-WorkBlog-LeHoaiLoc/images/5-Workshop/5.4-S3-onprem/dns.png)
...
![Start session](/AWS-WorkBlog-LeHoaiLoc/images/5-Workshop/5.4-S3-onprem/start-session.png)
...
![user](/AWS-WorkBlog-LeHoaiLoc/images/5-Workshop/5.4-S3-onprem/cli1.png)
...
![copy file](/AWS-WorkBlog-LeHoaiLoc/images/5-Workshop/5.4-S3-onprem/cli2.png)
...
![check bucket](/AWS-WorkBlog-LeHoaiLoc/images/5-Workshop/5.4-S3-onprem/check-bucket.png)

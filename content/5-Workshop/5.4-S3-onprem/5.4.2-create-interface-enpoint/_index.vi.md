...
![name](/AWS-WorkBlog-LeHoaiLoc/images/5-Workshop/5.4-S3-onprem/s3-interface-endpoint1.png)
...
![service](/AWS-WorkBlog-LeHoaiLoc/images/5-Workshop/5.4-S3-onprem/s3-interface-endpoint2.png)
...
![vpc](/AWS-WorkBlog-LeHoaiLoc/images/5-Workshop/5.4-S3-onprem/s3-interface-endpoint3.png)

5. Chọn 2 subnets trong AZs sau: us-east-1a and us-east-1b

![subnets](/AWS-WorkBlog-LeHoaiLoc/images/5-Workshop/5.4-S3-onprem/s3-interface-endpoint4.png)

6. Đối với Security group, chọn SGforS3Endpoint:

![sg](/AWS-WorkBlog-LeHoaiLoc/images/5-Workshop/5.4-S3-onprem/s3-interface-endpoint5.png)

7. Giữ default policy - full access và click Create endpoint

![success](/AWS-WorkBlog-LeHoaiLoc/images/5-Workshop/5.4-S3-onprem/s3-interface-endpoint-success.png)

...
![endpoint diagram](/AWS-WorkBlog-LeHoaiLoc/images/5-Workshop/5.5-Policy/s3-bucket-policy.png)
...
```
![test](/AWS-WorkBlog-LeHoaiLoc/images/5-Workshop/5.5-Policy/test1.png)
...
![create bucket](/AWS-WorkBlog-LeHoaiLoc/images/5-Workshop/5.5-Policy/create-bucket.png)

Successfully create bucket

![Success](/AWS-WorkBlog-LeHoaiLoc/images/5-Workshop/5.5-Policy/create-bucket-success.png)
...
![policy](/AWS-WorkBlog-LeHoaiLoc/images/5-Workshop/5.5-Policy/policy1.png)
...
![custom policy](/AWS-WorkBlog-LeHoaiLoc/images/5-Workshop/5.5-Policy/policy2.png)

Successfully customize policy

![success](/AWS-WorkBlog-LeHoaiLoc/images/5-Workshop/5.5-Policy/success.png)
...
![error](/AWS-WorkBlog-LeHoaiLoc/images/5-Workshop/5.5-Policy/error.png)
...
![success](/AWS-WorkBlog-LeHoaiLoc/images/5-Workshop/5.5-Policy/test2.png)

This operation succeeds because it is permitted by the VPC endpoint policy.

![success](/AWS-WorkBlog-LeHoaiLoc/images/5-Workshop/5.5-Policy/test2-success.png)
...
![fail](/AWS-WorkBlog-LeHoaiLoc/images/5-Workshop/5.5-Policy/test2-fail.png)

...
* Tích hợp giao diện và trải nghiệm người dùng (UX) cho các tính năng Social: Bảng tin (News Feed), bình luận thời gian thực và hệ thống thông báo (Notifications).
...
| 4 | - Tìm hiểu Amazon Bedrock và mô hình Amazon Nova Lite. <br>- Tích hợp hiển thị giao diện tính năng Social (News Feed, Comment, Like/Save) trên Next.js Frontend. <br>- Thiết kế prompt chuyên sâu và tích hợp code gọi API Bedrock để tự động tạo công thức. | 22/07/2026 | 22/07/2026 | [Amazon Bedrock User Guide](https://docs.aws.amazon.com/bedrock/latest/userguide/what-is-bedrock.html) |
...
* Hoàn thiện giao diện cho các tính năng tương tác mạng xã hội (Social Features), mang lại trải nghiệm người dùng mượt mà qua các component bình luận và news feed.
